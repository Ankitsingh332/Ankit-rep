...
namespace Sep14
{
    ...
    public class Searching
    {
        ...
        {
            movies.Add(new Movie("Amit", "Hindi", "Action", 20));
            movies.Add(new Movie("Salman", "Hindi", "Thriller", 40));
            movies.Add(new Movie("Karan", "Hindi", "Drama", 50));
            movies.Add(new Movie("AAmir", "Hindi", "Thriller", 60));
            movies.Add(new Movie("Pankaj", "Kannada", "Drama", 34));
        }
        public void search()
        {
